  ...
  const ptConfig = {
    ...
    content: {
      className: `
        ...
        ${
          disabled
            ? "bg-surface-100 text-text-color-secondary cursor-not-allowed"
            : ""
        }
      `,
      style: {
    ...
    bold: {
      className:
        "w-8 h-8 rounded-lg border-0 bg-transparent hover:bg-surface-200 text-text-color-secondary hover:text-text-color transition-colors duration-200",
    },
    italic: {
      className:
        "w-8 h-8 rounded-lg border-0 bg-transparent hover:bg-surface-200 text-text-color-secondary hover:text-text-color transition-colors duration-200",
