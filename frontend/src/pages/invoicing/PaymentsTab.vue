...
import NewPaymentDialog from '@/components/invoicing/payment/NewPaymentDialog.vue'
import NewReceiptDialog from '@/components/invoicing/payment/NewReceiptDialog.vue'
import CustomTabButtons from '@/components/common/CustomTabButtons.vue'
