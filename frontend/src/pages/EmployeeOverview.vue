<template>
    <div class="space-y-8" v-if="employeeResource">
      ...
      <div class="px-6">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="space-y-4">
              <div>
                ...
                <div class="mt-1 text-lg text-gray-900">{{ employee?.employee_name }}</div>
              </div>
              <div>
              ...
              <div>
                ...
                <div class="mt-1 text-lg text-gray-900">{{ formatDate(employee?.date_of_birth) }}</div>
              </div>
              <div>
                <label class="block text-sm font-medium text-gray-500">Nationality</label>
                <div class="mt-1 text-lg text-gray-900">{{ employee?.nationality }}</div>
              </div>
            </div>
            ...
            <div class="space-y-4">
              ...
              <div>
                ...
                <div class="mt-1 text-lg text-gray-900">{{ formatCurrency(employee?.salary) }}</div>
              </div>
              <div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div class="bg-white rounded-lg shadow p-6">
              <div class="flex items-center">
                ...
                <div class="ml-4">
                  <div class="text-sm font-medium text-gray-500">Projects Assigned</div>
            ...
            <div class="bg-white rounded-lg shadow p-6">
              <div class="flex items-center">
                <div class="p-3 rounded-full bg-purple-100">
                  <FeatherIcon name="award" class="w-6 h-6 text-purple-600" />
                </div>
                <div class="ml-4">
                  <div class="text-sm font-medium text-gray-500">Performance Score</div>
                  <div class="text-2xl font-bold text-gray-900">4.5/5</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <!-- Recent Projects -->
        <div class="mb-8">
          <h3 class="text-sm font-medium text-gray-500 mb-4">Recent Projects</h3>
            ...
            <table class="min-w-full divide-y divide-gray-200">
              ...
              <tbody class="bg-white divide-y divide-gray-200">
                <tr>
                  ...
                  <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">Team Lead</td>
